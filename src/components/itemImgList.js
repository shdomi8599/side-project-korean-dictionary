...
const ItemImgList = ({itemBlockHandler}) => {
    ...
    return (
        ...
        <div className="item_card_img">
            ...
            {adWepNum.map(x=> <ItemImgCard itemNum={x} key={x}/>)}
            </div>
            <div className="item_card_list">
            {shoesNum.map(x=> <ItemImgCard itemNum={x} key={x}/>)}
            </div>
            </div>
            <div className="item_setting">
            <div className="item_card_list">
            {supNum.map(x=> <ItemImgCard itemNum={x} key={x}/>)}
            </div>
            <div className="item_card_list">
            {apWepNum.map(x=> <ItemImgCard itemNum={x} key={x}/>)}
            </div>
            <div className="item_card_list">
            {armNum.map(x=> <ItemImgCard itemNum={x} key={x}/>)}
            </div>
            </div>
        </div>
        </div>
